...
2. **Content generation** — reads the diff between staging and production, generates three markdown outputs:
   - **GitHub Release notes** — technical, for developers and contributors
   - **Discord announcement** — casual, for the community
   - **Blog post** — accessible, for the general public
...
6. Generates three markdown outputs, each with its own tone and audience
7. On approval: fast-forwards production to staging, tags, pushes, creates GitHub release
8. Prints Discord and blog post markdown for you to copy
